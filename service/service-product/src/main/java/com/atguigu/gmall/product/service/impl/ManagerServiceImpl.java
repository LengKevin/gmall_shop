...
public class ManagerServiceImpl implements ManagerService {
	 ...
	 * @param baseAttrInfo
	 *
	 *                     Transactional： 默认配置的方式：只能对运行时异常进行回滚 RuntimeException
	 *
	 *                     rollbackFor = Exception.class IOException SQLException
	 *
	 *
	 */
	@Override
	 ...
	 * @param spuInfo
	 *
	 *                spuInfo涉及到的表 spu_info 基本信息表 spu_image 图片表 spu_poster 海报表
	 *                spu_sale_attr_value 销售属性值表 spu_sale_attr 销售属性表
	 */
	@Override
	@Transactional(rollbackFor = Exception.class)
	...
	/**
	 * 保存skuInfo 操作的表： sku_info 基本信息表 sku_image sku图片表 sku_sale_attr_value sku销售属性表
