...
public class SkuManagerController {
	...
	/**
	 * 商品的上架 admin/product/onSale/{skuId}
	 * 
	 * @return
	 */
	...
	/**
	 * 商品的下架 admin/product/cancelSale/{skuId}
	 * 
	 * @return
	 */
	...
	/**
	 * sku分页列表 admin/product/list/{page}/{limit}
	 * 
	 * @param page
	 * @param limit
	 * @return
	...
	/**
	 * admin/product/spuImageList/{spuId} 根据spuId查询图片列表
	 * 
	 * @param spuId
	 * @return
	 */
	...
	/**
	 * 根据spuId查询销售属性和销售属性值集合 admin/product/spuSaleAttrList/{spuId}
	 * 
	 * @return
	 */
